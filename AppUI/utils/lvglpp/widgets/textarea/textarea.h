...
namespace lvgl::widgets {
    ...
    public:
         ...
         *  \brief Enables/disables app_setting cursor position on click.
         *  \param en: if true, app_setting cursor position on click is enabled.
         */
         ...
         *  \brief Tells if app_setting cursor position on click is enabled.
         *  \returns true if app_setting cursor position on click is enabled, false otherwise.
         */
