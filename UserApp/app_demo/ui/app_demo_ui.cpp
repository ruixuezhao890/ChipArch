...
#include "app_demo_ui.h"
#include "ChipArch/ChipArch.h"
app_demo_ui::app_demo_ui(lv_pm_page_t *lv_pm_page_set): SCREEN_BASE(lv_pm_page_set) {

}

 app_demo_widget * app_demo_ui::getWidget() {
...
void lv_example_menu_5(lv_obj_t * cont_set, app_demo_ui * demo_ui)
{
    lv_obj_t * menu = lv_menu_create(cont_set);
    menu->user_data=demo_ui;
...
void app_demo_ui::initScreen(lv_obj_t *cont) {

    lv_example_menu_5(cont, this);
}

void app_demo_ui::deInitScreen(lv_obj_t *cont) {
